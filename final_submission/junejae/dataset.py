...
# Dataset which performs the preprocessing inside the class
...
# Dataset which just aquires the preprocessed dataframe
...
# Gender specific dataset
class JuneCustomDatasetGender(Dataset):
    def __init__(self, data_info, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)):
        self.mean = mean
        self.std = std
        self.num_classes = 2
        ...
        self.img_paths = self.data_info.img_path.tolist()
        self.transform = None
        self.label_arr = self.data_info.gender.tolist()
...
# Mask specific dataset
class JuneCustomDatasetMask(Dataset):
    def __init__(self, data_info, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)):
        self.mean = mean
        self.std = std
        self.num_classes = 3
        ...
        self.img_paths = self.data_info.img_path.tolist()
        self.transform = None
        self.label_arr = self.data_info['mask'].tolist()
...
class JuneCustomDatasetAge(Dataset):
    def __init__(self, data_info, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)):
        self.mean = mean
        self.std = std
        self.num_classes = 3
        ...
        self.img_paths = self.data_info.img_path.tolist()
        self.transform = None
        self.label_arr = self.data_info.age.tolist()
...
# Custimized probabilistic augmentation set for training and validating
class JuneCustomAug:
